...
def is_letter_in_secret_word(letter):
  ...
  guessed_letters.add(letter) # You can ignore this line

  # TODO: Check if the guessed letter is in the secret word
  # and if it is not, increment the failed attempts

  # Hint: use the 'in' keyword to check if the letter is in the secret word
  # Example:
  #   if letter in my_variable:
  #     return True
  #   ....
  pass
...
def draw_man():
  ...
  # TODO: Use if statements to only draw the hangman figure based on the number of failed attempts
  # Draw base
...
def play_hangman():
  ...
  #   The game will continue until the word is guessed or the failed attempts reach 9.
  #
  #   The game loop:
  ...
  #
  #  After the word is guessed or failed attempts reach 9:
  ...
  # This only runs after the while loop ends
  if is_word_guessed():
